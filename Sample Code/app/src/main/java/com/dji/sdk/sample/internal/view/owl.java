...
import com.dji.sdk.sample.internal.view.baseOwlView;
...
public class owl extends baseOwlView{
        ...
        if (ModuleVerificationUtil.isFlightControllerAvailable()) {
            ...
            flightController.setStateCallback(new FlightControllerState.Callback() {
                ...
                public void onUpdate(@NonNull FlightControllerState djiFlightControllerCurrentState) {
                    ...
                    writeToFile2(mContext,fileName,owlLogger);
                    showStringBufferResult();
                }
            });
        }
    }
    public void  writeToFile2(Context context, String filename, StringBuffer content) {
